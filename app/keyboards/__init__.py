...
from .keyboards import on_enter_keyboard, in_back_keyboard, send_contact_keyboard, verify_user_keyboard

__all__ = ["on_enter_keyboard", "in_back_keyboard",
           "send_contact_keyboard", "verify_user_keyboard",
           "admin_keyboard", "main_keyboard",
           "device_keyboard", "advanced_keyboard","confirm_keyboard","confirm_keyboard_inl"]
